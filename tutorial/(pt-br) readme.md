...
9° passo: Vamos selecionar as dimensões da janela do nosso programa, no canto direito, você pode ver umas linhas com um fundo amarelo, lá você pode encontrar as opções "Width: 800" e "Height: 600", vamos mudar as dimensões para "Width: 462" e "Height: 450".

10° passo: No parte esquerda, vemos várias opções de ferramentas, nós vamos precisar usar a ferramenta "label"
